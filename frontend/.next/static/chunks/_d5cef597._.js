...
(()=>{
    const e = new Error("Cannot find module 'qrcode.react'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
const mockAssets = [
    ...
    },
    {
        ...
        location: "Office A-103"
    },
    {
        id: "PC-004",
        name: "Lenovo ThinkPad X1",
        location: "Office A-104"
    }
];
function Page() {
    _s();
    ...
    const [qrContent, setQrContent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("PC-001");
    ...
    const [printSettings, setPrintSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        paperFormat: "A4",
        customWidth: 210,
        customHeight: 297,
        labelsPerRow: 3,
    ...
    const scaleX = maxPreviewWidth / printSettings.labelWidth;
    const scaleY = maxPreviewHeight / printSettings.labelHeight;
    const previewScale = Math.min(scaleX, scaleY, 3) // Max 3x scale
    ;
    const previewWidth = printSettings.labelWidth * previewScale;
    const previewHeight = printSettings.labelHeight * previewScale;
    const addElement = (type)=>{
        const newElement = {
            id: "".concat(type, "-").concat(Date.now()),
            type,
            content: type === "qr" ? qrContent : type === "text" ? "New Text" : "",
            fontSize: 12,
            x: 10,
            y: 10 + elements.length * 25,
            width: type === "qr" ? 30 : 80,
            height: type === "qr" ? 30 : 15
        };
        setElements([
            ...elements,
            newElement
    ...
    const exportToPDF = async ()=>{
        const pdf = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jspdf$2f$dist$2f$jspdf$2e$es$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]({
            ...
            unit: "mm",
            format: printSettings.paperFormat === "Custom" ? [
                printSettings.customWidth,
                printSettings.customHeight
            ] : printSettings.paperFormat.toLowerCase()
        });
        const pageWidth = printSettings.paperFormat === "Custom" ? printSettings.customWidth : printSettings.paperFormat === "A4" ? 210 : 215.9;
        const pageHeight = printSettings.paperFormat === "Custom" ? printSettings.customHeight : printSettings.paperFormat === "A4" ? 297 : 279.4;
        let assetIndex = 0;
        const totalLabels = printSettings.labelsPerRow * printSettings.labelsPerColumn;
        for(let row = 0; row < printSettings.labelsPerColumn; row++){
            for(let col = 0; col < printSettings.labelsPerRow; col++){
                if (assetIndex >= mockAssets.length) break;
                const asset = mockAssets[assetIndex];
                const x = printSettings.leftMargin + col * (printSettings.labelWidth + printSettings.horizontalSpacing);
                const y = printSettings.topMargin + row * (printSettings.labelHeight + printSettings.verticalSpacing);
                // Draw label border (for reference)
                pdf.setDrawColor(200, 200, 200);
                pdf.rect(x, y, printSettings.labelWidth, printSettings.labelHeight);
                // Generate QR code
                ...
                const qrSize = Math.min(printSettings.labelWidth * 0.4, printSettings.labelHeight * 0.8);
                pdf.addImage(qrImageData, "PNG", x + 2, y + 2, qrSize, qrSize);
                // Add text
                pdf.setFontSize(8);
                pdf.setTextColor(0, 0, 0);
                pdf.text(asset.name, x + qrSize + 4, y + 8);
                pdf.setFontSize(6);
                pdf.text(asset.id, x + qrSize + 4, y + 15);
                pdf.text(asset.location, x + qrSize + 4, y + 20);
                assetIndex++;
            }
        }
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SidebarInset"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-1 gap-4 p-4 pt-0",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: elements.map((element)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "absolute cursor-pointer border-2 ".concat(selectedElement === element.id ? "border-blue-500" : "border-transparent", " hover:border-blue-300"),
                                                        style: {
                                                            left: "".concat(element.x * previewScale, "px"),
                                                            top: "".concat(element.y * previewScale, "px"),
                                                            width: "".concat(element.width * previewScale, "px"),
                                                            height: "".concat(element.height * previewScale, "px")
                                                        },
                                                        onClick: ()=>setSelectedElement(element.id),
                                                        children: [
                                                            element.type === "qr" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(QRCode, {
                                                                value: element.content,
                                                                size: element.width * previewScale,
                                                                level: "M"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/admin/qr-labels/page.tsx",
                                                                lineNumber: 367,
                                                            ...
                                                            element.type === "text" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                style: {
                                                                    fontSize: "".concat(element.fontSize * previewScale, "px")
                                                                },
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    selectedEl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                className: "space-y-4",
                                                children: [
                                                    selectedEl.type === "text" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                                value: printSettings.paperFormat,
                                                    ...
                                                    printSettings.paperFormat === "Custom" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "grid grid-cols-2 gap-2",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
...
_s(Page, "XZfai19YSUIb/RL9/cYuTHXZr9s=");
_c = Page;
var _c;
...
//# sourceMappingURL=_d5cef597._.js.map